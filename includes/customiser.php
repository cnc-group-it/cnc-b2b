<?php
add_action("woocommerce_after_add_to_cart_quantity","cnc_b2b_add_personalise_button_product_page");
                    ...
                    <div class="width_50 left" > 
                        ...
                        >
                            ...
                            for($i=1;$i<=$postdata['engrave_no_of_customization'];$i++){
                                ?>
                                <div class="font_frontend <?php if($postdata['multiple_fonts']==1){ echo $postdata['engrave_fonts_'.$i]; } ?>
                                    <?php if($postdata['engrave_fonts_override_'.$i]==1){ echo 'override_this'; } ?>
                                    " style="
                    ...
                    <div class="width_50 right" >
                            ...
                            <div class="width_100 color_selection" >
                                            ...
                                            if(!empty($postdata['available_color_label'][0])):
                                                ...
                                                ?>
                                                <select class="engrave_color_class_select <?php if($postdata['color_for_variation']=='1'){ echo 'color_for_variation'; } ?> <?php if($postdata['override_font_color']){ echo 'override_font_color'; } ?>" >
                                             ...
                                             ?>
                                                ...
                                                <input type="radio" class="enagrave_color_class" data-id="1" value="<?php echo $value; ?>" id="enagrave_color_1_<?php echo $key; ?>" name="enagrave_color_1" <?php if($color==$value){ echo 'checked="checked"'; } ?> />
                            ...
                            ?>
                                    <div class="width_100">
                                        ...
                                        <div class="width_50">
                                        <div class="width_100 show_hide<?php echo $i; ?>" >
                                        <strong><div class="total_font" data-id="<?php echo $i; ?>" ><?php echo $postdata['max_character_'.$i]; ?></div></strong>
                                    ...
                                    if($postdata['engrave_font_size_type']=='fixed'){
                                        ...
                                        for($j=30;$j>=10;$j--){   
                                            ?>
                                            <option value=<?php echo $j; ?> <?php if($j==$postdata['font_size_'.$i]){ echo 'selected="selected"'; } ?> ><?php echo $j; ?></option>
                                            <?php
                                        }
                                        ?>
                                        </select>
